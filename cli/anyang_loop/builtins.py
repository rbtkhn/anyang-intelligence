...
BUILTINS = {
    "council-loop": LoopDefinition(
        name="council-loop",
        description="The canonical Executive Council loop: memory -> decision -> coordination -> review -> learning -> updated memory.",
        loop_type="operating",
        project_lane="shared",
        authority="human leadership",
        tags=["builtin", "executive-council", "canonical"],
        source_path="docs/loops.md",
        signal="A meaningful operating change, ambiguity, risk, commitment, or review moment requires Executive Council attention.",
        memory_objects=["Facts", "Assumptions", "Commitments", "Risks", "Open loops", "Prior decisions"],
        ...
        governance_boundary="Executive Council prepares judgment; humans retain authority over decisions, commitments, approvals, spending, external claims, and professional review.",
    ),
    "recursive-council-improvement-loop": LoopDefinition(
        name="recursive-council-improvement-loop",
        description="The Executive Council self-improvement loop that turns friction into better docs, skills, templates, or guardrails.",
        loop_type="recursive",
        project_lane="shared",
        authority="operator",
        tags=["builtin", "recursive", "executive-council"],
        ...
        memory_objects=["Recent work cycle", "Detected friction", "Learning", "Improvement candidate", "Affected skill, template, checklist, guardrail, or customer doc"],
        decision="Decide which one durable improvement would make the next work cycle smarter without overbuilding the system.",
        action="Update the chosen repo surface only after operator approval.",
        ...
        learning_update="Preserve learning as a reusable primitive while filtering private customer context through membranes.",
