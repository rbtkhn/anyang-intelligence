...
| # | Category | Candidate workflow | Required learning |
| --- | --- | --- | --- |
| 1 | Research-to-primitive | Promote one source-derived insight | Does the brief separate evidence, recommendation, and approval? |
