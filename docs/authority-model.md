...
Executive Council has a shared read surface across repository-visible
`projects/` artifacts. Grace Gems and other projects sit within that portfolio
surface; they are not the organizational container for Executive Council.
Private systems and cross-project transfer remain separately governed.
