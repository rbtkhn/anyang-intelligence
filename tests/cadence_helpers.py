...
def make_git_repo(root: Path, dashboard: str = "# Operating Portfolio Dashboard\n") -> None:
    ...
    write(root / "projects" / "operating-portfolio-dashboard.md", dashboard)
    write(root / "projects" / "comparison-matrix.md", "# Project Comparison Matrix\n")
    write(root / "projects" / "commercial-hypotheses.md", "# Commercial Hypotheses\n")
