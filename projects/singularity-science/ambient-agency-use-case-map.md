# Ambient Agency Use-Case Map

This map shows where ambient agency is most likely to matter across Anyang Intelligence lanes.

Its purpose is to identify likely use cases, likely value, and likely governance stress before ambient systems are normalized through convenience.
...
This map is advisory.

It may identify likely use cases and routing pressure. It may not create customer obligations, imply adoption, or treat ambient systems as approved by default.

## What Counts As Ambient Agency

Ambient agency appears when a system:

- works in the background
- stays present across time or context
- remembers prior state
- acts with limited prompting
- surfaces only selected decisions for human review

The key question is not whether the system is intelligent. The key question is whether the system quietly changes where agency, attention, and approval live.

## Lane Map

| Lane | Most likely use cases | Why it fits | Main risk | Default posture |
| --- | --- | --- | --- | --- |
...
Ambient agency is most likely to be useful where:

- repeated review cycles create attention fatigue
- the main bottleneck is context reconstruction
- humans still want final say
- persistent memory or monitoring reduces coordination overhead

Ambient agency is most likely to create risk where:

- humans stop noticing what was delegated
- approvals become symbolic
- background memory changes behavior without renewed consent
- the system touches children, money, rights, safety, donors, or public claims

## Governance Stress Points

The most common governance stress points across lanes are:

- hidden delegation
- low-visibility scope creep
- approval theater
- memory without fresh consent
- weak override paths
- humans signing off on outputs they did not meaningfully inspect

## Suggested Next Application Order
...
Do not route source-specific launch hype, benchmark comparisons, or vendor claims through this map.

Route only synthesized use-case pressure, governance warnings, and membrane-aware review questions.
