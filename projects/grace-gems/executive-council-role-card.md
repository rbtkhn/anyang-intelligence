# Grace Gems Executive Council Role Card

**Status:** Current project routing rule  
**Client:** Grace Gems  
**Real-world interface:** Executive Assistant

## Organizational position

Executive Council is an Anyang Intelligence layer over the full `projects/`
portfolio. It is not part of Grace Gems. This card applies the Council's
organization-wide roles to one client engagement; it does not define or contain
the Council.
...
The Grace Gems CEO is not an Executive Council member. The CEO may approve,
revise, hold, or reject Grace Gems decisions and authorize bounded client
evidence or action. This client authority does not transfer Anyang system
authority by implication.

Grace Gems contributors such as Eric and Jonathan are client-side participants,
not Executive Council members unless an explicit appointment says otherwise.
...
- Private customer, order, supplier, financial, or operational evidence remains
  in an owner-authorized private location outside Git.
- The Executive Assistant retrieves or verifies only the approved minimum and returns a
  minimized evidence receipt.
- The Chief Executive analyzes that returned evidence; it does not replace
  the Executive Assistant at the real-world interface.
...
- Every consequential communication names its authority, exact scope, required
  response, and returned evidence.
...
No role gains authority through access, fluency, continuity, interest, silence,
or prior practice. Listing, pricing, claims, policies, spending, publication,
customer communication, supplier or production commitments, and fulfillment
changes require the exact applicable Grace Gems approval.
