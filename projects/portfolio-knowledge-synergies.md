...
- Who is paying whom?
- Is the payee an individual, business, platform, or intermediary?
- What country is the contractor tax-resident in?
- Where will the services be physically performed?
- Is the contractor ever performing work inside the United States?
- Is the payment for services, reimbursement, software/tools, rights/licensing, or something else?
- What contract, invoice, payment record, W-8/W-9, owner approval, and bookkeeper/CPA review evidence is needed?

Safe default:

- U.S. contractor: collect W-9 and route 1099/payment reporting questions to the bookkeeper/CPA.
- Foreign contractor working entirely outside the United States: collect foreign status documentation such as W-8BEN or W-8BEN-E as applicable and prepare a CPA/bookkeeper question before recurring payments.
- Contractor working inside the United States, traveling while working, using a foreign intermediary, licensing IP, or involving sanctioned/restricted jurisdictions: hold final classification and require professional review.

Anyang Intelligence does not provide final tax, legal, accounting, payroll, labor-law, sanctions/export-control, VAT/GST, treaty, withholding, or permanent-establishment advice.

## Synergy Rules

Use these rules when moving knowledge between lanes:

- Transfer operating primitives, not customer facts.
- Preserve each customer's authority boundary.
- Preserve money classifications until evidence and professional review support a change.
