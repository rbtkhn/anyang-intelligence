...
- Use one synthetic or approved public-source topic throughout.
- Do not use client records, private economics, private source bodies, credentials, or client systems.
- Do not publish, contact anyone, create paid accounts, or purchase assets.
- Do not create an account or upload anything externally unless the trainer has separately authorized that action.
...
Use [the training review checklist](creative-production-operator-training-review.md). The trainer will explain the decision and give useful next steps. Trainer judgment determines `Pass`, `Remediate once`, or `Do not advance`.

One remediation attempt may address exact trainer-identified gaps. Passing does not authorize live work; the operator must still complete the ramp and assignment gate.
